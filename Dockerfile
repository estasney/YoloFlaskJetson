...
RUN pip install --no-cache-dir \
    https://github.com/estasney/yolov5Jetson/releases/download/w1.7.0/torch-1.7.0-cp38-cp38-linux_aarch64.whl \
...
#===========================
FROM build_torch AS build_nginx
...
RUN pip3 install --no-cache-dir tqdm Click \
    && rm -rf /home/pytorch \
    && rm -rf /home/vision \
